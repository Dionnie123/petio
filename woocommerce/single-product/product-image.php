...
if(petio_image_single_product()->product_layout_thumb == "scroll") 
	wc_get_template( 'single-product/content-image/scroll.php' );
elseif(petio_image_single_product()->product_layout_thumb == "one_column")
	wc_get_template( 'single-product/content-image/one_column.php' );
elseif(petio_image_single_product()->product_layout_thumb == "slider")
	wc_get_template( 'single-product/content-image/slider.php' );
elseif(petio_image_single_product()->product_layout_thumb == "grid")
	wc_get_template( 'single-product/content-image/grid.php' );
elseif(petio_image_single_product()->product_layout_thumb == "lagre_gallery")
	wc_get_template( 'single-product/content-image/lagre_gallery.php' );
elseif(petio_image_single_product()->product_layout_thumb == "clean")
	wc_get_template( 'single-product/content-image/clean.php' );
elseif(petio_image_single_product()->product_layout_thumb == "moderm")
	wc_get_template( 'single-product/content-image/moderm.php' );
elseif(petio_image_single_product()->product_layout_thumb == "full_width")
